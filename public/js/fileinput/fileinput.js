...
(function (factory) {
    ...
    defaultFileActionSettings = {
        ...
        dragClass: 'text-info',
        dragTitle: 'Mover / Agrupar',
        dragSettings: {},
        indicatorNew: '<i class="glyphicon glyphicon-hand-down text-warning"></i>',
        indicatorSuccess: '<i class="glyphicon glyphicon-ok-sign text-success"></i>',
        indicatorError: '<i class="glyphicon glyphicon-exclamation-sign text-danger"></i>',
        indicatorLoading: '<i class="glyphicon glyphicon-hand-up text-muted"></i>',
        indicatorNewTitle: 'No subidos aún',
    ...
    FileInput.prototype = {
        ...
        _validate: function () {
            ...
            $exception = '<div class="help-block alert alert-warning">' +
                '<h4>El tipo de Docuemnto no es vlido</h4>' +
                '´Debes seleccionar uno <code>type = file</code> for <b>bootstrap-fileinput</b> plugin to initialize.' +
                '</div>';
        ...
        _submitForm: function () {
            ...
            if (files && self.minFileCount > 0 && self._getFileCount(files.length) < self.minFileCount) {
               // self._noFilesError({});
                //return false;
				return true;  //para qualityue acepte el documento sin imagen
            }
            return !self._abort({});
        },
    ...
    $.fn.fileinput = function (option) {
        ...
        this.each(function () {
            var self = $(this), data = self.data('fileinput'), options = typeof option === 'object' && option,
                ...
                lang = options.language || self.data('language') || idioma, opts;
            if (!data) {
                if (theme) {
    ...
    $.fn.fileinputLocales.es = {
        fileSingle: 'Documento',
        filePlural: 'documentos',
        browseLabel: 'Buscar &hellip;',
        removeLabel: 'Quitar',
        removeTitle: 'Quitar Documentos Seleccionados',
        cancelLabel: 'Cancelar',
        cancelTitle: 'Abortar la subida',
        uploadLabel: 'Subir',
        uploadTitle: 'Subir los documento seleccionados',
        msgNo: 'No',
        msgNoFilesSelected: 'No ha seleccionado documentos',
        msgCancelled: 'Cancelado',
        msgZoomModalHeading: 'Previsualización',
        msgSizeTooSmall: 'File "{name}" (<b>{size} KB</b>) es demaciado pequeño para ser agrandado <b>{minSize} KB</b>.',
        msgSizeTooLarge: 'File "{name}" (<b>{size} KB</b>) excede el máximo de subidas <b>{maxSize} KB</b>.',
        msgFilesTooLess: 'debe seleccioanr al menos  <b>{n}</b> {files} para subir.',
        msgFilesTooMany: 'Número de documentos seleccionados  <b>({n})</b> excede el límite máximo <b>{m}</b>.',
        msgFileNotFound: 'Documento "{name}" no se encuentra!',
        msgFileSecured: 'Restricciones de seguridad restringen la lectura del documento "{name}".',
        msgFileNotReadable: 'Documento "{name}" no se puede leer.',
        msgFilePreviewAborted: 'se abortó la previsualización de "{name}".',
        msgFilePreviewError: 'Ocurrió un error mientras se leía el documento "{name}".',
        msgInvalidFileName: 'Existen Caracteres no soportados en el documento"{name}".',
        msgInvalidFileType: 'El Tipo "{name}". Solo "{types}" son soportados',
        msgInvalidFileExtension: 'Extención del documento invalida "{name}". solo "{extensions}" como extensión es soportada',
        msgUploadAborted: 'La subida del archivo fue abortada',
        msgUploadThreshold: 'Procesando...',
        msgValidationError: 'Error en validación',
        msgLoading: 'Cagando Documentos {index} de {files} &hellip;',
        msgProgress: 'Cargando documento {index} de {files} - {name} - {percent}% Completada.',
        msgSelected: '{n} {files} Seleccionados',
        msgFoldersNotAllowed: 'Sólo arrastre y suelte! {n} folder(s) ',
        msgImageWidthSmall: 'El ancho de la imagen "{name}" debe ser menor que {size} px.',
        msgImageHeightSmall: 'El alto de la imagen "{name}" debe ser menor que {size} px.',
        ...
        msgImageResizeError: 'No puedo tomar las dimenciones de la imagen para ajustar el tamaño',
        msgImageResizeException: 'Error mientras reajustaba la imagen.<pre>{errors}</pre>',
        dropZoneTitle: 'Arrastre y suelta la imagen aca &hellip;',
        dropZoneClickTitle: '<br>(O pulse click para seleccionar {files})',
        previewZoomButtonTitles: {
            prev: 'Ver docuemnto anterior',
            next: 'Ver proximo Documento',
            toggleheader: 'ocultar/ver cabecera',
            fullscreen: 'Agrandar',
            borderless: 'Ocultar/ver bordes',
            close: 'Cerrar Previsualizacion'
        }
    };
    ...
    $.fn.fileinputLocales.en = {
            ...
            removeLabel: 'Remove',
            removeTitle: 'Remove Selected Documents',
            cancelLabel: 'Cancel',
            cancelTitle: 'Abort the climb',
            uploadLabel: 'Go up',
            uploadTitle: 'Upload selected documents',
            msgNo: 'do not',
            msgNoFilesSelected: 'You have not selected documents',
            msgCancelled: 'Canceled',
            msgZoomModalHeading: 'Preview',
            msgSizeTooSmall: 'File "{name}" (<b>{size} KB</b>) Is too small to be enlarged <b>{minSize} KB</b>.',
            msgSizeTooLarge: 'File "{name}" (<b>{size} KB</b>) Exceeds maximum uploads <b>{maxSize} KB</b>.',
            msgFilesTooLess: 'You must select at least  <b>{n}</b> {files} to upload.',
            msgFilesTooMany: 'Number of documents selected  <b>({n})</b> Exceeds the ceiling <b>{m}</b>.',
            msgFileNotFound: 'Document "{name}" Is not found!',
            msgFileSecured: 'Security Restrictions Restrict Document Read "{name}".',
            msgFileNotReadable: 'Document "{name}" it can not be read.',
            msgFilePreviewAborted: 'Aborted preview of "{name}".',
            msgFilePreviewError: 'An error occurred while reading the document "{name}".',
            msgInvalidFileName: 'Characters not supported in the document "{name}".',
            msgInvalidFileType: 'Type "{name}". Only "{types}" Are supported',
            msgInvalidFileExtension: 'Extension of invalid document "{name}". only "{extensions}" As extension is supported',
            msgUploadAborted: 'File upload was aborted',
            msgUploadThreshold: 'Processing...',
            msgValidationError: 'Validation error',
            msgLoading: 'Shitting Documents {index} of {files} &hellip;',
            msgProgress: 'Shitting Document {index} of {files} - {name} - {percent}% completed.',
            msgSelected: '{n} {files} Selected',
            msgFoldersNotAllowed: 'Just drag and drop! {n} folder(s) ',
            msgImageWidthSmall: 'The width of the image "{name}" Must be less than {size} px.',
            msgImageHeightSmall: 'The height of the image "{name}" Must be less than {size} px.',
            msgImageWidthLarge: 'The width of the image "{name}" Can not exceed {size} px.',
            msgImageHeightLarge: 'The height of the image "{name}" Can not exceed {size} px.',
            msgImageResizeError: 'I can not take the dimensions of the image to adjust the size',
            msgImageResizeException: 'Error while resizing the image.<pre>{errors}</pre>',
            dropZoneTitle: 'Drag and drop the image here &hellip;',
            dropZoneClickTitle: '<br>(Or click to select {files})',
            previewZoomButtonTitles: {
                prev: 'View previous document',
                next: 'See next document',
                toggleheader: 'Hide / see header',
                fullscreen: 'Enlarge',
                borderless: 'Hide / View borders',
                close: 'Close Preview'
            }
        };
